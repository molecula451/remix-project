...
import { createInstance, getContext, getFuncABIInputs, getSelectedContract, loadAddress, runTransactions, updateInstanceBalance, syncContractsInternal, lastCompilationResultsInternal } from './deploy'
...
export const lastCompilationResults = () => lastCompilationResultsInternal(plugin)